...
@section("content")
 <!-- filter and Body -->
<div class="container sharingContentBody margin-top-10 carOwnerPage">
    <div class="col-md-12">
        <div class="col-md-12 sharingRideGrid">
            ...
            <div class="col-md-12">
                <div class="col-md-12 detailBlock">
                    <table class="table margin-top-10 table-td-border-none">
                        <tbody>
                            <tr>
                    ...
                    <div class="cabOwnerNotes">
                        <div class="col-md-1 col-xs-2 col-sm-1 text-right">
                            <i class="zmdi zmdi-pin-account zmdi-hc-2x margin-top-20 text-right"></i>
                        </div>
                        <div class="col-md-10 col-xs-10 col-sm-11">
